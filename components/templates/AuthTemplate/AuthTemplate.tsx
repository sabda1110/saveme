...
export function AuthTemplate({ children }: AuthTemplateProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[var(--color-bg-base)] text-[var(--color-text-primary)] flex flex-col items-center justify-center p-4">
  ...
  return (
    <div className="relative min-h-screen bg-[var(--color-bg-base)] text-[var(--color-text-primary)] flex flex-col items-center justify-center p-4 sm:p-6 bg-mesh-pattern overflow-hidden transition-colors">
      ...
      <div className="w-full max-w-md flex items-center justify-between mb-8 z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-xs text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors bg-white dark:bg-[#1a1d27]/80 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-[#2d3348] shadow-sm dark:shadow-none"
          >
