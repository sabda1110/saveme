  ...
  return (
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl bg-gradient-to-b from-[#1a1d27] via-[#1a1d27]/95 to-[#131620] border border-green-500/30 p-8 sm:p-14 text-center shadow-2xl overflow-hidden">
          {/* Subtle grid mesh */}
