...
export function SingleTabGuard() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 dark:bg-black/85 backdrop-blur-xl animate-in fade-in duration-300">
      <div className="w-full max-w-md bg-white dark:bg-[#161924] border border-slate-200 dark:border-[#2d3348] rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden flex flex-col items-center text-center animate-in zoom-in-95 duration-200">
        ...
        {/* Warning Icon Badge */}
        <div className="w-16 h-16 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-500 dark:text-amber-400 flex items-center justify-center mb-5 shadow-lg shadow-amber-500/5">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
          <Button
            ...
            className="w-full sm:w-1/2 justify-center text-xs text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white border border-slate-200 dark:border-[#2d3348]"
        ...
        <span className="text-[11px] text-slate-500 dark:text-slate-400 mt-5">
