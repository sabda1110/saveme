  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-md animate-in fade-in">
      <div className="bg-[#1a1d27] border border-[#2d3348] rounded-t-3xl sm:rounded-2xl w-full max-w-lg p-5 sm:p-7 shadow-2xl relative max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom-6 sm:slide-in-from-none duration-200">
        ...
        {!selectedImage ? (
          <div className="flex flex-col items-center justify-center border-2 border-dashed border-[#2d3348] hover:border-purple-500/50 rounded-2xl p-8 text-center transition-colors bg-[#21263a]/30">
            <div className="w-16 h-16 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-400 flex items-center justify-center mb-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#2d3348] bg-black max-h-56 flex items-center justify-center group">
              ...
              {!scanning && !scanResult && (
                <button
                  type="button"
                  onClick={handleReset}
                  className="absolute top-2 right-2 p-1.5 rounded-lg bg-black/70 text-slate-300 hover:text-white hover:bg-black transition-all"
                  title="Ganti Foto"
                >
                  <X className="w-4 h-4" />
                </button>
            ...
            {/* Extracted Data View */}
            {scanResult ? (
              <div className="p-4 rounded-2xl bg-[#21263a] border border-emerald-500/40 shadow-xl flex flex-col gap-3.5 animate-in fade-in">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-[#1a1d27] border border-[#2d3348]">
                  ...
                  <div className="p-3 rounded-xl bg-[#1a1d27] border border-[#2d3348]">
                    ...
                    <span className="text-xs sm:text-sm font-bold font-mono text-green-400 block mt-0.5">
                ...
                {scanResult.items && scanResult.items.length > 0 && (
                  <div className="mt-1 pt-2 border-t border-[#2d3348]">
                    ...
                    <div className="max-h-24 overflow-y-auto flex flex-col gap-1 pr-1">
                      {scanResult.items.map((it, idx) => (
                        <div
                          key={idx}
                          className="flex items-center justify-between text-[11px] text-slate-300 bg-[#1a1d27]/70 px-2.5 py-1 rounded-lg border border-[#2d3348]/60"
                        >
                ...
                <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-[#2d3348]">
