        ...
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Kelola data akun, mode pengguna (karyawan / pelajar / freelance), dan target menabungmu
            </p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSaveProfile} className="flex flex-col gap-5 sm:gap-6">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#1a1d27] border border-[#2d3348] shadow-xl flex flex-col gap-4 sm:gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-slate-300">Pilih Mode Pengguna:</label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <button
                ...
                className={cn(
                  ...
                  incomeType === 'SALARIED'
                    ...
                    : 'bg-[#21263a]/60 border-[#2d3348] text-slate-400 hover:text-white'
                )}
              >
                <div className="flex items-center gap-2">
                  <Briefcase className="w-4 h-4 text-purple-400" />
                  <span className="text-xs font-bold text-white">Karyawan</span>
                </div>
                <span className="text-[10px] text-slate-400">Gaji tetap &amp; tanggal gajian</span>
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-white">Pelajar / Mahasiswa</span>
                </div>
                <span className="text-[10px] text-slate-400">Uang saku &amp; jatah jajan</span>
              </button>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-white">Freelancer / Bebas</span>
                </div>
                <span className="text-[10px] text-slate-400">Tanpa jadwal gajian tetap</span>
              </button>
            </div>
          </div>
          ...
          {incomeType === 'SALARIED' && (
            <div className="p-4 rounded-2xl bg-[#21263a]/50 border border-[#2d3348] space-y-3">
