...
import type { RecurringBill, SavingsGoal, Transaction, Wallet } from '@/types'
...
export default function DailyBudgetPage() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        const [txs, bills, goals, userWallets] = await Promise.all([
  ...
  // Daily Savings Required across all active goals
